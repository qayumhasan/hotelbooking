...
class CreateMaintenanceDistributionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('maintenance_distributions', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('maintenance_distributions');
    }
}
