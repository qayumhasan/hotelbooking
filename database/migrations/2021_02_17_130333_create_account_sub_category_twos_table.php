...
class CreateAccountSubCategoryTwosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('account_sub_category_twos', function (Blueprint $table) {
            $table->id();

            $table->string('subcategory_nametwo')->nullable();
    ...
    {
        Schema::dropIfExists('account_sub_category_twos');
    }
}
