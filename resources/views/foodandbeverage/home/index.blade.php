                  ...
                  <div class="row p-0">
                     ...
                     <div class="col-6">
                        ...
                        <li class="list-group-item bg-menu">
                              <a class="bg-menu kitchen" type="button" data-toggle="modal" data-target=".bd-example-modal-xl" data-id="{{$row->id}}"><i class="fa fa-history" aria-hidden="true"></i> Kot</a>
                              <input type="hidden" class="booking_no" value="{{$row->checkin['booking_no'] ?? ''}}">
                           </li>
                           <li class="list-group-item bg-menu">
                              <a class="bg-menu kitchen billing" type="button" data-toggle="modal" data-target=".bd-example-modal-lg" data-id="{{$row->id}}"><i class="fa fa-globe" aria-hidden="true"></i> Billing</a>
                           </li>
                           <li class="list-group-item bg-menu">
                              <a class="bg-menu kitchen" type="button" data-toggle="modal" data-target="#newmodal" data-id="" ><i class="fa fa-calendar-check" aria-hidden="true"></i> History</a> 
                           </li>
                        </ul>
                     </div>
                  </div>
