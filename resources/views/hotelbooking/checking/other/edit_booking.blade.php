                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="date" class="controll-from" name="expected_checkout_date" required id="pwd1">
                                                </div>
                                                <div class="col-sm-2">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <span class="text-right pl-2">Qayum Hasan</span>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                <label class="control-label col-sm-2 align-self-center" for="email">Tariff<small class="text-danger">*</small></label>
                                                <div class="col-sm-4">
                                                    <input type="text" class="controll-from" name="tariff" value="gfds" required id="pwd1">
                                                </div>
                                                <label class="control-label col-sm-2 align-self-center" for="email">Non-Taxable</label>
