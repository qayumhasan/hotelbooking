                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card shadow-sm shadow-showcase">
                                ...
                                <form action="{{url('admin/addroom/existingbooking/submit')}}" method="post">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="form-group row">
                                                <label class="control-label col-sm-3 align-self-center" for="email">Select Room No:</label>
                                                <div class="col-sm-6">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group row">
                                                <label class="control-label col-sm-3 align-self-center" for="email">Guest Name:</label>
                                                <div class="col-sm-3">
                                                    <input type="text" name="guest_name" class="form-control form-control-sm" value="">
                                                </div>
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group row">
                                                <label class="control-label col-sm-3 align-self-center" for="email">CheckIn Date And Time:</label>
                                                <div class="col-sm-4">
