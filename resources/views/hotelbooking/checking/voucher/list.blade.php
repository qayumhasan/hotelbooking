                     ...
                     <div class="table-responsive">
                              ...
                              <tr>
                                 ...
                                 <td>
                                   ...
                                   <a class="badge bg-primary-light mr-2" data-toggle="tooltip" data-placement="top" href="{{route('admin.checkin.edit.voucher.page',$data->id)}}" data-original-title="Edit"><i class="lar la-edit"></i></a>
