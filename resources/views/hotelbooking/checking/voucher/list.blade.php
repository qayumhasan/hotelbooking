                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$row->amount}}</td>
                                <td>
                                <a class="badge bg-primary-light mr-2" data-toggle="tooltip" data-placement="top" href="{{route('admin.checkin.edit.voucher.page',$row->id)}}" data-original-title="Edit"><i class="lar la-edit"></i></a>
                                </td>
                            </tr>
                            @php
