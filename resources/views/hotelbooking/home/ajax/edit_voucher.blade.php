                            ...
                            <div class="col-sm-8">
                                <div class="form-group">
                                    ...
                                    <select name="credit" class="form-control form-control-sm" id="exampleFormControlSelect1">
                                        <option>{{$editvoucher->credit}}</option>
                                    </select>
                                </div>
                                <br>
                        ...
                        <div class="row p-4">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="amount" required onkeyup="getDebetValue(this)" class="form-control form-control-sm" id="exampleFormControlInput1" value="{{$editvoucher->amount}}">
                                </div>
                                <br>
                                <div class="form-group">
                                    <input type="text" disabled class="form-control form-control-sm" id="exampleFormControlInput1">
