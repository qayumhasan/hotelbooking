                                                    ...
                                                    <tbody class="text-center">
                                                        ...
                                                        @endphp
                                                            ...
                                                            <tr>
                                                                ...
                                                                <!-- <button type="button" onclick="cartdata(this)" data-toggle="tooltip" title="" class="editcat badge bg-primary-light" value="{{$data->id}}" data-original-title="Edit"><i class="lar la-edit"></i></button> -->
